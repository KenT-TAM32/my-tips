...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[user.@exsample.com USER@foo.COM A_US-ER@foo.bar.org first.last@foo.jp alice+bob@baz.cn]
  ...
  test "associated micropsts should be destroyed" do
    @user.save
